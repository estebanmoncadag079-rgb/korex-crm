...
| [52-CARGAR-EL-CATALOGO-DE-CITAS.md](52-CARGAR-EL-CATALOGO-DE-CITAS.md) | **Un salón no tenía dónde subir sus servicios**: el alta le ocultaba el paso y la única puerta era teclearlos de uno en uno (son 46). Pegar la lista o subir la foto, con tabla de revisión, y **por qué la duración de cada servicio no puede quedar vacía** |
