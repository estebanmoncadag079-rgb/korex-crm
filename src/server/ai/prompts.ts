...
export const CONTRATO_DE_ACCIONES_CITAS = [
  ...
  '- {"action":"book_appointment","servicios":["...", "..."],"fecha":"DD/MM/AAAA","hora":"HH:MM 24h","especialista":"opcional","farewell":"opcional"} — agenda la cita. Solo con un horario que confirmaste con consult_availability EN ESTE TURNO O EL INMEDIATO ANTERIOR, y que el cliente aceptó explícitamente.',
