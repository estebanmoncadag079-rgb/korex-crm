...
const FICHA: Required<FichaDelNegocio> = {
  ...
  pago: {
    ...
    porModalidad: { domicilio: ["transferencia"], recoger: ["transferencia", "efectivo"] },
    cuentaAntesDeConfirmar: "nunca",
  },
  politicaDeCancelacion: "Se puede cambiar con 24 horas de anticipación.",
  fueraDeHorario: { tomaPedidos: true },
  respuestaAPublicaciones: "responder",
  mensajes: { derivar: "Ya te comunico con alguien del equipo 💗" },
  tono: "cercano",
